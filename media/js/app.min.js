...
App.confirm = function(message,callback){
	apprise(message, {'verify':true},function(result){
		if(result)
			callback();
	});
}
...
App.seen = function(el){
	var id_list = new Array();
	jQuery(el).find("[notify-id]").each(function(){
		id_list.push($(this).attr("notify-id"))
	})
	$.cookie("seen",id_list);
}

App.popup = function(message,html,callback){
	apprise(message+"<br/>", {'confirm':true,"html":html},function(result,item){
		if(result)
