...
class Cookie
{
  ...
  public function getRaw($name,$default = ""){
	   return (isset($_COOKIE[$name]) ? $_COOKIE[$name] : $default);
  }
  
  public function get($name, $default = '')
  {
    return (isset($_COOKIE[$name]) ? unserialize($_COOKIE[$name]) : $default);
  }
...
public function setRaw($name, $value, $expiry = self::OneYear, $path = '/', $domain = false)
  {
